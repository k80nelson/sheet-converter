...
#Lots to configure --use python converter.py -h for deets
...
def main():
    ...
    default_template_path = os.path.join(os.getcwd(), 'Runtime', 'Templates',
                                         'Template.xlsx')
    ...
    parser.add_argument('--template', default=default_template_path,
                         help='Path to template file. WARNING: CHANGE CONFIG \
                         FILE IF TEMPLATE HAS CHANGED')
